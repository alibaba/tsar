...
//#define LVS_STATS "/home/like/ip_vs_stats"
...
*******************************************************
*/
static void read_lvs(struct module *mod)
{
	st_lvs.stat = 0;
	st_lvs.conns = 0;
	st_lvs.pktin = 0;
	...
	//printf(LVS_STORE_FMT(DATA_SPLIT),st_lvs.stat,st_lvs.conns,st_lvs.pktin,st_lvs.pktout,st_lvs.bytin,st_lvs.bytout);
	if(st_lvs.stat == 1){
